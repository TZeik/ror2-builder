        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {RARITY_ORDER.map((rarity) => (
              ...
              >
                <span className={`w-2 h-2 rounded-full ${selectedRarities.includes(rarity) ? RARITY_STYLES[rarity].bg : 'bg-current opacity-80'}`}></span>
              ...
              return (
                <Tooltip.Root key={item.id}>
                  <Tooltip.Trigger asChild>
                    <div
                      className={`relative w-16 h-16 ${rarityStyle.bg} border ${rarityStyle.border} rounded-lg p-2 transition-colors cursor-pointer flex flex-col items-center justify-center`}
                    ...
                    >
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          <p
                            className={`text-xs ${rarityStyle.text} capitalize`}
                          >
                            {item.rarity}{" "}
